...
function App() {
  ...
  return (
    <div className='grid grid-cols-5 text-center bg-zinc-900'>
      {/* Sidebar - Placeholder for History/Navigation */}
      <div className='col-span-1 bg-zinc-800 h-screen border-r border-zinc-700 hidden md:block'>
        <div className='p-6 text-white font-bold text-xl tracking-tight'>AI Chatbot</div>
        <div className='px-4'>
          <button
            onClick={() => {
              setMessages([]);
            ...
            className='w-full py-2 px-4 rounded-lg bg-zinc-700 hover:bg-zinc-600 text-zinc-300 transition-colors text-sm'
          >
            + New Chat
          </button>
        </div>
      ...
      {/* Main Chat Area */}
      <div className='col-span-1 md:col-span-4 p-4 md:p-10 flex flex-col h-screen max-w-5xl mx-auto w-full'>
